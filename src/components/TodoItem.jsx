...
const TodoItem = ({ todo, index }) => {
  ...
  return (
    <div className='flex flex-col sm:flex-row sm:items-center justify-between border-b-2 py-2 gap-4'>
      ...
      <div className='space-x-3 ml-8'>
        ...
        <button
          ...
          className='mr-2 text-sm bg-purple-500 text-white sm:px-2 py:1 px-1 rounded'
        >
          <FaTrash />
        </button>
        {!todo.completed && (
